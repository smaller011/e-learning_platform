function validateForm() {
    ...
    // Password validation
    const password_regex = /^(?=(?:.*\d){4})(?=.*[!@#$%^&*])(?=(?:.*[a-z]){3})(?=.*[A-Z]).{8,}$/;
    ...
    if (password.value === "") {
        ...
        password_error.textContent = "Password should contain 3 digits, 3 lowercase letters, a special character, and an uppercase letter";
        password.classList.add("invalid");
        invalid = true;
    }
